                ...
                <div class="invoice-inner-9" id="invoice_wrapper">
                    ...
                    <div class="invoice-info">
                        ...
                        <div class="row">
                            <div class="col-sm-6 mb-50">
                                ...
                                <p class="inv-from-1">Wail ihabritane</p>
                                <p class="inv-from-1">0678990908</p>
                                <p class="inv-from-1">wail@gmail.com</p>
                                <p class="inv-from-2">Sale</p>
                            </div>
                        </div>
                    </div>
                    <div class="order-summary">
                        <div class="table-outer">
                            <table class="default-table invoice-table">
                                ...
                                <tr>
                                    <td colspan="3"><strong>Prix HT</strong></td>
                    ...
                    {{-- <div class="invoice-informeshon-footer">
                        <ul>
                            ...
                            <li><a href="tel:+088-01737-133959">+212 6788977</a></li>
                        </ul> --}}
                    </div>
                </div>
                <!-- END: Invoice Details -->
